package com.vn.beta_testing.auth_service.controller;
...
import com.vn.beta_testing.auth_service.repository.PasswordResetTokenRepository;
...
import com.vn.beta_testing.domain.request.auth.ReqForgotPassword;
import com.vn.beta_testing.domain.request.auth.ReqLoginDTO;
import com.vn.beta_testing.domain.response.RestLoginDTO;
import com.vn.beta_testing.domain.response.google.GoogleUser;
import com.vn.beta_testing.domain.response.user.ResCreateUserDTO;
import com.vn.beta_testing.email_service.EmailService;
...
public class AuthController {
    ...
    @Value("${beta_testing.jwt.refresh-token-validity-in-seconds}")
